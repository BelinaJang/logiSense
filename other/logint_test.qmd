...
```{r}
logint2(stroke ~ work_type*Residence_type, variable1 = "work_type", variable2 = "Residence_type", variable1_type = "categoricals", variable2_type = "categorical",data=test_data, sigfig=4)
```
## NA in estimate
```{r}
