...
# convert the type of bmi to numeric
...
```{r}
output <- logint(stroke ~ work_type*age, continuous_var = "age", categorical_var = "work_type", data=test_data)
```
